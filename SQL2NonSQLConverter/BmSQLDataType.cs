...
namespace SQL2NonSQLConverter
{
    class BmSQLDataType
    {
        public const int SQL_DATA_TYPE_CHAR      = 0;
        public const int SQL_DATA_TYPE_VARCHAR   = 1;
        public const int SQL_DATA_TYPE_TEXT      = 2;
        public const int SQL_DATA_TYPE_BLOB      = 3;
        public const int SQL_DATA_TYPE_INT       = 4;
